		...
		<div className="w-full h-full overflow-y-scroll relative">
						...
						<tbody>

							{
								users.map((user) => (
									...
									<tr
										key={user.email}
										className="border-b border-secondary/10 hover:bg-secondary/5 transition-all duration-200"
									>
			...
			<div className="absolute bottom-5 left-0 w-full h-[50px] flex justify-center items-center pointer-events-none">
				...
				<div className="w-[500px] h-full bg-white shadow-2xl rounded-full flex items-center justify-center px-2 pointer-events-auto">
					...
					<button
						className="bg-accent text-white p-2 rounded-full w-[100px] cursor-pointer hover:bg-accent/80"
						onClick={() => {
