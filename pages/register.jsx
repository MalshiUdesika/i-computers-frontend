...
export default function RegisterPage() {
	...
	return (
		<div className="w-full h-full bg-[url('public/images/background.jpg')] bg-cover no-repeat bg-center flex">
			...
			<div className="w-full lg:w-[50%] h-full  flex justify-center items-center">
				<div className="text-white backdrop-blur-3xl w-[450px] h-[700px] shadow-2xl rounded-lg flex flex-col justify-center">
